...
void Json(){
  ...
  while (teste < 50){
    positionLatitude.add(0);
    positionLongitude.add(0);
    degreesLatitude.add(39);
    degreesLongitude.add(17);
    minutesLatitude.add(15);
    minutesLongitude.add(22);
    secondsLatitude.add(8877);
    secondsLongitude.add(6655);
    teste++;
  }
      ...
      if (gps.location.isValid())
      {
        while (numberOfSamples < 10){
          if (gps.location.isUpdated()) {
            ...
            // CRIAÇÃO DE VETOR
            Serial.println(positionLatitude);
            Serial.println(positionLongitude);
            ...
            Serial.println(dmsML);
            Serial.println(dmsMN);
